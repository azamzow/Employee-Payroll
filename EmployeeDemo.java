...
public class EmployeeDemo
{
   public static void main(String[] args)
   {
      ...
      // Create the second employee. Uses the constructor that accepts arguments for all  of the fields.
      Employee employee2 = new Employee("Mark Jones", 39119, "IT", "Programmer");

      // Create the third employee. Use the constructor that accepts the name and ID number.
